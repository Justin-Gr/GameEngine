...
public class ModeledTerrain extends Terrain {
	...
	public ModeledTerrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightmap) {
		super(gridX, gridZ);
